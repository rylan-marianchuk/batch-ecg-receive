...
parser.add_argument('--deid_xml_dir', help="")
parser.add_argument('--puid_map', help="")
parser.add_argument('--xml_dir', help="")
parser.add_argument('--h5_dir', help="")
args = parser.parse_args()
receive = ReceiveECGs(deid_xml_dir=args.deid_xml_dir, puid_map=args.puid_map, xml_dir=args.xml_dir, h5_dir=args.h5_dir)
start = time.time()
